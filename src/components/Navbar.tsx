...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  // 2. Campus Facilities (4 Features)
  const adminFeatures = [
    {
      id: 'rooms',
  ...
  return (
    <>
      ...
      {/* 🟢 100% FIXED MOBILE DRAWER (WORKS ON BOTH APP AND WEBSITE) */}
      {isSidebarOpen && (
        <div className="fixed inset-0 z-50 flex h-full min-h-screen">
          <div
            onClick={() => setIsSidebarOpen(false)}
            className="fixed inset-0 bg-black/70 backdrop-blur-xs transition-opacity"
          />

          <div className={`relative w-84 max-w-[85vw] h-full min-h-full border-r shadow-2xl flex flex-col justify-between z-10 transition-colors ${
            ...
            {/* 2. 🟢 MIDDLE MENU AREA: Full Height on Mobile App */}
            <div className="flex-1 min-h-0 overflow-y-auto p-3.5 space-y-4">
              
              {/* Student Services (4 Features) */}
